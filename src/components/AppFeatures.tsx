    ...
    <section className="py-16" ref={ref}>
      <div className="px-6 lg:px-12 max-w-7xl mx-auto">
        ...
        <div className={`flex justify-center mt-8 reveal ${isVisible ? 'visible' : ''} reveal-delay-3`}>
          <a href="https://www.toliv.com/download-app" target="_blank" rel="noopener noreferrer" id="download-app-cta" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-opacity glow-primary">
            {t.downloadApp}
          </a>
        </div>
      </div>
