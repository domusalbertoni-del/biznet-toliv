        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link to="/artists" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Toliv for Artists</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link to="/consumer-info" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Consumer Information</Link></li>
            </ul>
          </div>
        </div>
