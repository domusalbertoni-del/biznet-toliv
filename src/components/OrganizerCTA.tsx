          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-base text-muted-foreground mb-8 max-w-md">
                Your event deserves the best crowd. Smart targeting, real-time analytics, and seamless ticketing.
              </p>
              <Link
                to="/organizers"
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl font-semibold hover:opacity-90 transition-opacity text-accent-foreground"
                style={{ background: 'linear-gradient(135deg, hsl(16, 90%, 55%), hsl(350, 80%, 58%))' }}
              >
                List my event
